 ...
 *
 * The model maintains a single string input by the user using the GUI and echoed by the GUI
 *
 * The view is the GUI.
 *
 * The controller reacts whenever the user presses a button. It acts as communicator
 * between model and view, and thus separates them.
 *
 ...
 *
 * Handling keyboard and mouse events is not covered yet. This must be done in a scalable way,
